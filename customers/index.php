...
<header>
    ...
    <div class="header-3">
        ...
        <div class="icons">
            ...
            <a href="user_info.php" class="fas fa-user-circle"></a>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <a href="bonsai.php" class="btn">Mua ngay</a>
            </div>
        </div>
        <div class="box">
            ...
            <div class="content">
                <h3>Cho ngôi nhà của bạn</h3>
                <a href="homeplant.php" class="btn">Mua ngay</a>
            </div>
        </div>
        <div class="box">
            ...
            <div class="content">
                <h3>Cho văn phòng của bạn</h3>
                <a href="officeplant.php" class="btn">Mua ngay</a>
            </div>
        </div>
        <div class="box">
            ...
            <div class="content">
                <h3>Quà tặng</h3>
                <a href="gift.php" class="btn">Mua ngay</a>
            </div>
        </div>
        ...
        if(mysqli_num_rows($query_run) > 0){
            foreach($query_run as $bonsai){
                ...
                <div class="box">
                    ...
                    <div class="price">Giá: <?= $bonsai['price'];?> VND</div>

                    ...
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        if(mysqli_num_rows($query_run) > 0){
                            foreach($query_run as $receipt){
                                ...
                                $id2=$receipt['cart_id'];
                                $sql1="select bonsai_name from bonsai where bonsai_id
                                    in(select bonsai_id from cart where cart_id='$id2')";
                                $bonsai_name = mysqli_fetch_assoc(mysqli_query($conn,$sql1));

                                if($receipt['receipt_id']==1){
                                    $text='Chờ xử lý';
                                    $type='info';
                                }elseif($receipt['receipt_id']==0){
                                    $text='Chưa xử lý';
                                    $type='warning';
                                }else{
                                    $text='Đã xử lý';
                                ...
                                <tr>
                                    ...
                                    <td> <?= $name['fullname']; ?> </td>
                                    <td> <?= $receipt['day_buy'] ?></td>
                                    <td> <?= $bonsai_name['bonsai_name'] ?></td>
                                    <td> <?= $receipt['sum_price']  ?> VND</td>
                                    <td>

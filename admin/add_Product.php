...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="./receipt.php"><i
                        class='app-menu__icon bx bx-pie-chart-alt-2'></i><span class="app-menu__label">Quản lý hóa đơn</span></a>
        </li>
                ...
                <div class="tile-body">
                    ...
                    <form class="row" action="./controller.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input class="form-control" type="text" name="bonsai_name" id="bonsai_name">
                        </div>
                        ...
                        <div>
                            <button class="btn btn-save" type="submit" name="addProduct" id="addProduct">Lưu lại</button>

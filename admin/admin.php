...
include "../session.php";
    ...
    $sum_customer = mysqli_fetch_assoc($query_run);



    /* Tổng sản phẩm */
    $query_1 ="select count(bonsai_id) from bonsai";
    $query_run1= mysqli_query($conn,$query_1);
    $sum_bonsai = mysqli_fetch_assoc($query_run1);

    /* Tổng tài khoản */
    $query_2 ="select count(username) from accounts";
    $query_run_2= mysqli_query($conn,$query_2);
    $sum_account = mysqli_fetch_assoc($query_run_2);


    /* Tổng đơn hàng */
    $query_3 ="select count(receipt_id) from receipt";
    $query_run_3= mysqli_query($conn,$query_3);
    $sum_receipt = mysqli_fetch_assoc($query_run_3);
...
<aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="../uploads/hay.jpg" width="50px"
        ...
        <div>
            ...
            <p class="app-sidebar__user-designation">Xin chào admin</p>
        </div>
    </div>
    <hr>
    <ul class="app-menu">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="widget-small primary coloured-icon"><i class='icon bx bxs-user fa-3x'></i>
                        <div class="info">
                            ...
                            <p><b><?=$sum_customer['count(email)']?> khách hàng</b></p>
                ...
                <div class="col-md-6">
                    <div class="widget-small info coloured-icon"><i class='icon bx bxs-data fa-3x'></i>
                        <div class="info">
                            <h4>Tổng sản phẩm</h4>
                            <p><b><?=$sum_bonsai['count(bonsai_id)']?> sản phẩm</b></p>
                ...
                <div class="col-md-6">
                    <div class="widget-small primary  coloured-icon"><i class='icon bx bxs-user-account fa-3x'></i>
                        <div class="info">
                            <h4>Tài khoản</h4>
                            <p><b><?=$sum_account['count(username)']?> tài khoản</b></p>
                            <p class="info-tong">Số tài khoản đang quản lí</p>
                        </div>
                    </div>
                </div>
                <!-- col-6 -->
                <div class="col-md-6">
                    <div class="widget-small warning coloured-icon"><i class='icon bx bxs-shopping-bags fa-3x'></i>
                        <div class="info">
                            <h4>Tổng đơn hàng</h4>
                            <p><b>     <?=$sum_receipt['count(receipt_id)']?> đơn hàng</b></p>
